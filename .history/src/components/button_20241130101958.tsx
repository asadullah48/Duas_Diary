...
export default function Button() {
  ...
  return (
    <div className="bg-[#4b64f1] w-[81px] h-[59px] flex flex-col items-center justify-between">
      ...
      <div className="flex space-x-2 mt-2">
        <button
          onClick={handleClick}
          className="bg-[#2f992f] w-[20px] h-[20px] px-1 py-1 rounded-full border mt-1 mb-1 border-white flex items-center justify-center text-center"
        >
          +
        </button>
